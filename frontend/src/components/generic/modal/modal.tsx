      ...
      {isModalOpen && (
        ...
        >
          <div className="relative w-full max-w-md max-h-full">
            <div className="relative bg-eggshell border border-flesh rounded-xl">
              <div className="flex flex-col items-start justify-center p-4 md:p-5 border-b rounded-t border-flesh">
                <button
                  type="button"
                  className="text-stone bg-transparent rounded-full text-sm w-8 h-8 inline-flex justify-center items-center hover:bg-flesh transition-all duration-200 ease-in-out"
